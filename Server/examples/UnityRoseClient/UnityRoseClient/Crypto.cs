...
namespace Network.Cryptography
{
	/// <summary>
	...
	public static class AES
	{
		...
		public static string Encrypt(string plainText, string password = null, string salt = null, string initialVector = null)
		{
		...
		/// <param name="initialVector">Needs to be 16 ASCII characters long</param>    
		/// <returns>An encrypted string</returns>        
		public static byte[] EncryptToBytes(string plainText, string password = null, string salt = null, string initialVector = null)
		{
		...
		/// <param name="initialVector">Needs to be 16 ASCII characters long</param>    
		/// <returns>An encrypted string</returns>        
		public static byte[] EncryptToBytes(byte[] plainTextBytes, string password = null, string salt = null, string initialVector = null)
		{
			int keySize = 256;
		...
		public static string Decrypt(string cipherText, string password = null, string salt = null, string initialVector = null)
		{
		...
		/// <param name="initialVector">Needs to be 16 ASCII characters long</param> 
		/// <returns>A decrypted string</returns>
		public static string Decrypt(byte[] cipherTextBytes, string password = null, string salt = null, string initialVector = null)
		{
			int keySize = 256;
